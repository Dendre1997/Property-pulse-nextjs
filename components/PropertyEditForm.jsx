...
// To trigger a refresh or re-fetch of the updated data
  ...
  useEffect(() => {
    if (isUpdated) {
      ...
      router.replace(`/properties/${property._id}?updated=${Date.now()}`)
    }
  }, [isUpdated, property._id, router]);
  ...
  return (
    <>
      <form onSubmit={handleSubmit}>
        ...
        <UpdatePropertyImages images={property.images}/>
        <div>
          <button
